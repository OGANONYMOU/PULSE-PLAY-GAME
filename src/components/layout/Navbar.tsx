        ...
        <div className="glass rounded-2xl px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center gap-3 group">
              ...
              <span className="font-orbitron text-xl font-bold gradient-text hidden sm:block">PulsePay</span>
            </Link>
              ...
              >
                {navLinks.map((link) => (
                  <Link
                    ...
                    className={'block px-4 py-2 rounded-xl text-sm font-medium transition-colors ' + (location.pathname === link.href ? 'bg-cyan-500/10 text-cyan-400' : 'text-muted-foreground hover:bg-muted')}
                  >
                    {link.label}
                  </Link>
                ))}
