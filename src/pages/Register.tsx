...
import { Eye, EyeOff, Mail, Lock, User, Phone, Gamepad2, Trophy, DollarSign, ArrowLeft, Loader2 } from 'lucide-react';
...
const stats = [
  { value: '10K+', label: 'Gamers', icon: Gamepad2 },
  { value: '50+', label: 'Tournaments', icon: Trophy },
  { value: '₦5M+', label: 'Prizes', icon: DollarSign },
];
...
function getPasswordStrength(password: string): PasswordStrength {
  ...
  if (score <= 50) return { score: 50, label: 'Fair', color: 'bg-yellow-500' };
  if (score <= 75) return { score: 75, label: 'Good', color: 'bg-cyan-500' };
...
export function Register() {
  ...
  const handleOAuthSignIn = async (provider: 'google' | 'twitter' | 'discord' | 'facebook') => {
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        >
          <Link to="/" className="inline-flex items-center gap-3 mb-8">
            ...
            <span className="font-orbitron text-2xl font-bold gradient-text">PulsePay</span>
          </Link>
        ...
        >
          <div className="gaming-card p-8">
            ...
            <div className="text-center mb-8">
              <h2 className="font-orbitron text-2xl font-bold mb-2">Get Started!</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <Label htmlFor="terms" className="text-sm text-muted-foreground cursor-pointer">
                  I agree to the{' '}
                  <Link to="#" className="text-cyan-400 hover:underline">Terms of Service</Link>
                  {' '}and{' '}
                  <Link to="#" className="text-cyan-400 hover:underline">Privacy Policy</Link>
                </Label>
              </div>

              <Button
                type="submit"
                className="w-full h-12 bg-gradient-to-r from-cyan-500 to-purple-600 font-bold"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
