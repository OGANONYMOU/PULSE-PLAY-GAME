...
function MatchDrawer(p: { match: Match; onClose: () => void; onUpdated: () => void }): React.ReactElement {
  ...
  return (
    <motion.div initial={{ x: '100%' }} animate={{ x: 0 }} exit={{ x: '100%' }}
      ...
      className="fixed top-0 right-0 bottom-0 z-50 w-full sm:w-96 max-w-full bg-[#0a0a16]/98 border-l border-white/10 backdrop-blur-2xl flex flex-col shadow-2xl">
      {/* Header */}
