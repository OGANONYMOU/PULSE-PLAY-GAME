...
function FeaturedBanner(p: { game: Game }): React.ReactElement {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
      ...
      <div className="gaming-card p-5 sm:p-8 md:p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <h2 className="font-orbitron text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">{g.name}</h2>
